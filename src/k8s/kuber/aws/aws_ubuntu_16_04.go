		...
		ServerPools: []*cluster.ServerPool{
			{
				...
				BootstrapScripts: []string{
					"https://raw.githubusercontent.com/datalayer/datalayer/main/aws/aws_k8s_ubuntu_16.04_master.sh",
				},
			...
			},
			{
				...
				Size:     "r4.2xlarge",
				BootstrapScripts: []string{
					"https://raw.githubusercontent.com/datalayer/datalayer/main/aws/aws_k8s_ubuntu_16.04_node.sh",
				},
				InstanceProfile: &cluster.IAMInstanceProfile{
