...
const useStyles = makeStyles(styles, {index: 11, classNamePrefix: 'DlaW1HeaderLinks'});
...
export default function HeaderLinks(props) {
  ...
  return (
    <List className={classes.list + " " + classes.mlAuto}>
      <ListItem className={classes.listItem}>
        <CustomDropdown
          ...
          dropdownList={[
            ...
            <a
              href="https://datalayer.io/material-kit-pro-react/#/documentation/tutorial?ref=mkpr-navbar"
              target="_blank"
      ...
      <ListItem className={classes.listItem}>
        <Button
          href="https://datalayer.io?ref=mkpr-navbar"
