...
const useStyles = makeStyles(SignUpPageStyle as any, {index: 111, classNamePrefix: 'DlaSignUp1'});

export default function DlaSignUp1({ ...rest }) {
                      ...
                      <form className={classes.form}>
                        ...
                        <FormControlLabel
                          ...
                          label={
                            <span>
                              I agree to the{" "}
                              <a href="#datalayer">terms and conditions</a>.
                            </span>
                          }
                        />
                        <div className={classes.textCenter}>
              ...
              <div className={classes.left}>
                <List className={classes.list}>
                  <ListItem className={classes.inlineBlock}>
                    <a
                      href="https://datalayer.io/?ref=mkpr-SignUp"
                      target="_blank"
                  ...
                  <ListItem className={classes.inlineBlock}>
                    <a
                      href="https://datalayer.io/presentation?ref=mkpr-SignUp"
                      target="_blank"
                      className={classes.block}
                    >
                      About us
                  ...
                  <ListItem className={classes.inlineBlock}>
                    <a
                      href="https://datalayer.io/license?ref=mkpr-SignUp"
                      target="_blank"
                      className={classes.block}
                    >
                      Licenses
