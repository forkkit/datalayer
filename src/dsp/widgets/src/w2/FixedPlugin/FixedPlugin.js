...
const useStyles = makeStyles(styles, {index: 12, classNamePrefix: 'DlaW2FixedPlugin'});
        ...
        <ul className="dropdown-menu">
          ...
          <li className="button-container">
            <div>
              <Button
                color="warning"
                href="https://datalayer.io/product/material-dashboard-pro-react?ref=mdpr-fixed-plugin"
                target="_blank"
                fullWidth
              >
                Buy now
          ...
          <li className="button-container">
            <div>
              <Button
                color="warning"
                href="https://datalayer.io/material-dashboard-pro-react/#/documentation/tutorial?ref=mdpr-fixed-plugin"
                target="_blank"
                fullWidth
              >
                Buy now
