...
import CardAvatar from "./../w1/Card/CardAvatar";
import Info from "./../w1/Typography/Info";
import Danger from "./../w1/Typography/Danger";
import Success from "./../w1/Typography/Success";
import Warning from "./../w1/Typography/Warning";
import Rose from "./../w1/Typography/Rose";
...
const useStyles = makeStyles(styles as any, {index: 111, classNamePrefix: 'DlaCard'});
...
export default function DlaCard() {
  ...
  const addStylesForRotatingCards = () => {
    ...
    for (let i = 0; i < rotatingCards.length; i++) {
      var rotatingCard = rotatingCards[i] as any;
      var cardFront = rotatingCard.getElementsByClassName(classes.front)[0] as any;
      var cardBack = rotatingCard.getElementsByClassName(classes.back)[0] as any;
      cardFront.style.height = "unset";
      cardFront.style.width = "unset";
      cardBack.style.height = "unset";
      cardBack.style.width = "unset";
      var rotatingWrapper = rotatingCard.parentElement as any;
