...
import DashTable from "./../w2/Table/Table";
import DashButton from "./../w2/CustomButtons/Button";
import DashDanger from "./../w2/Typography/Danger";
import DashCard from "./../w2/Card/Card";
...
const useStyles = makeStyles(styles as any, {index: 111, classNamePrefix: 'DlaCard2'});
