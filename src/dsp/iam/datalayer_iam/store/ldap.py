...
def init_ldap_users():
    ...
    # add_user(conn, 'admin', os.environ['DLA_PWD'], 'admin', 'info@datalayer.io')
    # add_user(conn, 'datalayer,', os.environ['DLA_PWD'], 'datalayer', 'info@datalayer.io')
    add_ldap_user(conn, 'eric', '123', 'Eric', 'Charles', 'eric@datalayer.io')
    add_ldap_user(conn, 'ingrid', '123', 'Ingrid', 'B', 'ingrid@datalayer.io')
    add_ldap_user(conn, 'edmond', '123', 'Edmond', 'C', 'edmond@datalayer.io')
    add_ldap_user(conn, 'eleonore', '123', 'Eléonore', 'C', 'eleonore@datalayer.io')
    df = get_ldap_users()
