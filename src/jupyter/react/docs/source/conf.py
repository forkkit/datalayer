...
# -*- coding: utf-8 -*-
#
# JupyterLab React documentation build configuration file, created by
...
project = 'JupyterLab React'
copyright = '2020, Datalayer'
author = 'Project Datalayer'
...
html_context = {
    ...
    "github_user": "datalayer",  # Username
    "github_repo": "jupyterlab-react",  # Repo name
...
latex_documents = [
    (master_doc, 'JupyterLabReact.tex', 'JupyterLab React Documentation',
     'Project Datalayer', 'manual'),
]
...
man_pages = [
    (master_doc, 'jupyterlabReact', 'JupyterLab React Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'JupyterLab React', 'JupyterLab React Documentation',
     author, 'Datalayer', 'One line description of project.',
     'Miscellaneous'),
]
...
github_doc_root = 'https://github.com/datalayer/jupyterlab-react/tree/master/docs/'
